...
from functions.overview.overview import get_suburb_recent_growth, get_suburb_latest_median_price
...
def register_overview_callbacks(callback_manager):
    ...
    def update_header_date_component(suburb_value):
        ...
        return suburb_value, latest_median_price, five_year_growth